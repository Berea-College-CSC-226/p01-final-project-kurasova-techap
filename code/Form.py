...
class Form:
    def __init__(self, screen, x_shift = 0, nameLabel = "Your Name:"):
        ...
        :param x_shift: the shift in the x coordinate.
        """
        ...
        self.DOB_text.place(x = x_shift + 50, y = 130)
        self.birth_month_combo_box = ctk.CTkComboBox(screen, values = months, width = 110, state = "readonly")
        self.birth_month_combo_box.place(x = x_shift + 50, y = 170)
        self.birth_day_combo_box = ctk.CTkComboBox(screen, values = days, width = 60, state = "readonly")
        self.birth_day_combo_box.place(x = x_shift + 170, y = 170)
        self.birth_year_combo_box = ctk.CTkComboBox(screen, values = years, width = 85, state = "readonly")
        self.birth_year_combo_box.place(x = x_shift + 240, y = 170)
        self.gender_text = ctk.CTkLabel(screen, text = "Biological Sex:", font = ("Arial", 15, "bold"))
        self.gender_text.place(x = x_shift + 50, y = 210)
